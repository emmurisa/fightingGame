...
class Player {
  ...
  strike(player, enemy, attackDmg) {
    ...
    // Get random number between 1 - attackDmg and that is damageAmount
...
let player1 = new Player('Emmanuel', 100, 10)
let player2 = new Player('Diana', 100, 10)
...
document.addEventListener('keydown', function (e) {
  ...
  if (e.key.toUpperCase() === 'A' && p1.health > 0 && game.isOver === false) {
...
document.addEventListener('keydown', function (e) {
  ...
  if (e.key.toUpperCase() === 'L' && p2.health > 0 && game.isOver === false) {
    // After healing then play heal sound
    p2.heal(p2)
